...
## 2026-08-05 to 2026-08-07 — Ingest: Dr. Sarene MOA7006 course folder (radiation protection standards + clinical training curricula)

Digested a 15-document folder (`MP Files/MMPSemester I/MOA7006-Radiobiology and radiation Protection/Dr. Sarene/Dr. Sarene/`), organized per user selection into "grouped by document family." Three of five planned pages completed this pass:

**[[standard_ICRP-recommendations-history]]** (new page) — ICRP Publications 26 (1977), 60 (1990), and 103 (2007) read from primary sources, tracing the dose-quantity/limit lineage (Q→wR/wT formalism, 50 mSv/yr flat → 20 mSv/yr averaged-over-5yr occupational limit, mathematical→tomographic reference phantoms). Used to **verify** (not contradict) [[standard_ICRP-radiation-protection]]'s existing ICRP 103 figures against the primary document — no errors found; that page's History section updated accordingly, closing a verification gap flagged since 2026-08-03.

**[[protocol_NCRP-facility-shielding]]** (new page) — NCRP Report 147 (diagnostic imaging, air-kerma-based) and NCRP Report 151 (megavoltage radiotherapy, dose-equivalent-based, neutron/maze/door design), filling a citation gap previously left open in [[equipment_LINAC-and-cobalt60-teletherapy]] and [[equipment_simulators-and-imaging]]. **Flagged divergence** (not silently resolved): both NCRP reports derive their shielding design goals from NCRP's own 50 mSv/yr + 10 mSv×age(yr) cumulative occupational limit, distinct from the ICRP 20 mSv/yr-averaged-over-5-years figure documented in the ICRP lineage page above — two related but numerically different national/international occupational dose-limit frameworks.

**[[protocol_IAEA-clinical-training-curricula]]** (new page) — IAEA TCS-37 (radiation oncology, 2009), TCS-47 (diagnostic radiology, 2010), TCS-50 (nuclear medicine, 2011): the same RAS6038 regional-project template across three specialties, converging on an identical 4-year CQMP qualification formula (bachelor's + postgraduate Master's + ≥2 yr structured clinical training). Deepens the qualification-pathway figure already cited in [[protocol_establishing-radiotherapy-service]]. **Depth caveat:** only front-matter/Introduction/Objective sections were read for all three; Appendix IV (Clinical Training Guide) and Appendix V (Competency Assessment) — the largest, most substantive sections in all three documents — were not read this pass and remain a flagged gap for future ingest.

Two further pages completed 2026-08-07, closing out the folder:

**[[standard_IAEA-safety-standards-hierarchy]]** (new page) — SF-1 *Fundamental Safety Principles* (2006, read in full: all 10 principles) and GSR Part 3 *International Basic Safety Standards* (2014, read: front matter, Background/Introduction, Requirements table of contents). Confirmed the BSS lineage (Safety Series 9 [1962/1967/1982] → BSS 1996 → GSR Part 3 [2011 interim, 2014 final]), paralleling the ICRP lineage. **Used to close a previously-flagged gap:** found ICRP's April 2011 eye-lens dose-limit revision (150 mSv/yr → 20 mSv/yr averaged over 5yr, max 50 mSv/yr) documented in GSR Part 3's Background section — applied this to update [[standard_ICRP-radiation-protection]]'s dose-limit table, closing the "(under revision)" flag that page had carried since 2026-08-03. Not a contradiction: a confirmation of an already-flagged pending revision.

**[[protocol_planned-exposure-situation-requirements]]** (new page) — four IAEA PGEC teaching modules (VI.1 Generic, VI.2 Occupational, VI.3 Public, VI.4 Medical exposure, all Nov 2013) that elaborate GSR Part 3's planned-exposure Requirements 6-42 in full operative/practical detail — substantially filling the "GSR Part 3 operative Requirements not read" gap flagged the same day in [[standard_IAEA-safety-standards-hierarchy]]. Module VI.4 (medical exposure) is of particular direct relevance: confirms "no legal dose limit for medical exposure of patients," details diagnostic reference levels, patient release criteria after radionuclide therapy (including the modern post-discharge airport-security-alarm consideration), and the unintended/accidental medical exposure investigation framework. Noted as a provenance caveat (not a contradiction): these modules cite the 2011 Interim GSR Part 3 edition rather than the 2014 final edition, though content matched everywhere cross-checked.

Emergency exposure situations (GSR Part 3 Section 4), existing exposure situations (Section 5), and the numeric Schedule III dose-limit tables remain unread — flagged for future ingest. No contradictions found across any of the five pages in this folder ingest. Updated `index.md` (5 new entries total across this folder: 3 under Protocols, 2 under Standards).

## 2026-08-08 — Ingest (in progress): IAEA Diagnostic Radiology Physics handbook (MP Library)

Starting a full, page-by-page, multi-session ingest of two large IAEA "Handbook for Teachers and Students" companion volumes in `MP Library/`: *Diagnostic Radiology Physics* (2014, 24 chapters) and *Nuclear Medicine Physics* (2014), per user request and AskUserQuestion selection ("full page-by-page, multi-session" depth; "both, diagnostic radiology first" scope). Planned as ~14 wiki-page clusters per handbook, tracked as individual tasks.

**First cluster complete: [[concept_diagnostic-radiology-physics-fundamentals]]** (new page) — Chapters 1-3 (Fundamentals of Atomic and Nuclear Physics; Interactions of Radiation with Matter; Fundamentals of Dosimetry), read in full. Extends rather than duplicates [[concept_radiation-interactions]] and [[protocol_ICRU-60-quantities-and-units]]: adds diagnostic-energy-range quantitative depth (photoelectric/Compton/coherent cross-section formulas, K-edge data for W/Mo/Cu, attenuation and stopping-power coefficients) and entirely new formal material not previously in the wiki (charged particle equilibrium, Bragg-Gray cavity theory, the Fano theorem, Burlin cavity theory, and their combination into practical ion-chamber dosimetry equations). Notable finding: diagnostic-energy secondary-electron ranges are sub-millimetre, so dose buildup is confined to the skin surface — a direct, source-documented contrast with megavoltage therapy beams' 1-2 cm buildup/skin-sparing already discussed in this wiki's therapy pages. No contradictions found. Cross-linked both existing pages' History sections back to the new page. Updated `index.md` (1 new entry under Concepts).

**Second cluster: [[concept_medical-image-quality-theory]]** (new page) — Chapter 4, §4.1-4.6.3 (Measures of Image Quality): LSI systems theory, stationarity/ergodicity, sampling theory and aliasing, the three contrast definitions (Weber/modulation/subject-image-display), PSF/LSF/ESF/MTF and the presampling-MTF measurement method, noise power spectrum, DQE/NEQ, SNR, and the Rose criterion/Wagner taxonomy for detection-limiting regimes. Entirely new material — the wiki had no image-quality-theory page previously. §4.6.4 and Chapter 18 (Image Perception and Assessment) not yet read; deferred to a future pass. No contradictions found.

**Third cluster: [[equipment_x-ray-tube-and-generator]]** (new page) — Chapter 5 (X Ray Production), read in full: bremsstrahlung/characteristic-radiation spectrum shape, tungsten vs. molybdenum/rhodium anode choice, line focus principle and heel effect (including its deliberate exploitation in mammography), anode thermal engineering and tube rating charts, generator waveform technology (single-phase/three-phase/high-frequency/capacitor-discharge/constant-voltage) and the direct dose/exposure-time trade-off between them, falling-load and AEC exposure control, and the collimation/filtration dose-contrast-tube-loading triad. Entirely new equipment-specific material — complements the wiki's existing megavoltage-only equipment pages. No contradictions found.

**Fourth cluster: [[concept_projection-radiography-physics]]** (new page) — Chapter 6 (Projection Radiography), read in full: primary contrast and scatter-fraction formalism, projection geometry effects (superposition, distortion, inverse square law, magnification imaging, geometric unsharpness), contrast agents and K-edge optimization, dual-energy imaging, kV/mAs technique selection (Rose-criterion-derived photon-count requirement, the 15%/5%/10kV empirical rules, "exposure creep"), scatter magnitude dependencies, and antiscatter grids (construction, Bucky factor, contrast improvement factor, misalignment modes) plus non-grid scatter-reduction alternatives (collimation, compression, air gap, scanning slit). No contradictions found.

**Fifth cluster: [[equipment_projection-radiography-receptors]]** (new page) — Chapter 7 (Receptors for Projection Radiography), read in full: quantum detection efficiency, Swank factor, DQE(0), quantum accounting/secondary quantum sink, receptor blur mechanisms, screen-film systems (phosphor/film physics, H&D curve, reciprocity failure), digital sampling/aliasing, computed radiography (photostimulable phosphor), and flat panel detectors (direct conversion a-Se vs. indirect conversion CsI, TFT active matrix technology), plus scanning geometries and digital artefacts. No contradictions found.

**Sixth cluster: [[equipment_fluoroscopy]]** (new page) — Chapter 8 (Fluoroscopic Imaging Systems), read in full: XRII physics (gain mechanisms, conversion factor), video/CCD camera characteristics, fluoroscopic AEC and electronic magnification, contrast/spectral shaping, XRII-specific distortions (veiling glare, vignetting, blooming, pincushion, S-distortion), adjunct imaging modes (DSA, roadmapping, rotational angiography/CBCT), application-specific system design (conventional, remote, C-arm, cardiology, mobile), operating modes (continuous/pulsed, grid-controlled tubes, recursive filtering), and fluoroscopy-specific dosimetry (KAP, reference point air kerma, peak skin dose, patient/operator radiation safety). No contradictions found; flagged a future cross-check against the existing [[equipment_diagnostic-imaging-dosimetry]] page's fluoroscopy content (not performed this pass).

Remaining chapters (18 partial, 9, 10, 11, 12-13, 14-15, 16-17, 19, 20, 21-22, 23-24) tracked as pending tasks; will continue in subsequent turns.
